...
- the map pane now also has a temporary square grey placeholder pane in the top-right corner, sized from the zoom-control parent pane width and aligned to the same outer margins; the earlier crosshair toggle behavior is currently turned off
