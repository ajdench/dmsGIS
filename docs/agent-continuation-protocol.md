...
6. `docs/sidebar-parity-bugs.md`

If the task touches historical sidebar context or reset rationale, also read:

7. `docs/sidebar-production-reset-plan.md`
8. `docs/sidebar-thread-reactivation.md`

If the task touches the prototype contract directly, also read:

9. `src/prototypes/sidebarPrototype/PROMOTION.md`
10. `src/prototypes/sidebarPrototype/PROMOTION_BOUNDARY.md`
11. `src/prototypes/sidebarPrototype/PRODUCTION_PREPARATION.md`
...
> Read `AGENTS.md`, `README.md`, `docs/agent-handover.md`, `docs/sidebar-pane-status.md`, and `docs/prototype-to-production-playbook.md` first. Continue from the live production exact-sidebar path, not the older provisional sidebar path. Update canonical docs and checkpoint with `jj` after each logical change.
